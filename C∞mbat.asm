...
MissileSpeed  .byte  $01   ; Inicializa a velocidade do míssil com valor baixo (por exemplo, 1)
...
MotMis  JSR  MOTORS            ; Continue with motor sound
	JMP  MisAge

MisFly  LDA  AltSnd,X
	BEQ  MisBoom             ; Only do explosion sound when missile expires
	JSR  MOTORS
	LDA  #$30
	STA  MisLife,X
	JMP  MisAge
;
MisBoom	; Explosion sound is kept here
	JSR  BoomSnd            ; Sound when missile explodes
...
;
MVtable   .BYTE  $00 ,$00       ; Mantém o valor inicial, sem ajuste
          .BYTE  $60 ,$60       ; Aceleração mais moderada (começo mais suave)
          .BYTE  $80 ,$80       ; Aceleração um pouco mais rápida
          .BYTE  $90 ,$90       ; Aceleração boa, mas sem ser excessiva
          .BYTE  $A0 ,$A0       ; Aceleração bem controlada para maior velocidade
          .BYTE  $C0 ,$C0       ; Aceleração mais forte (intermediária)
          .BYTE  $D0 ,$D0       ; Aceleração aumentando, mas sem exagerar
          .BYTE  $E0 ,$E0       ; Aceleração mais forte, mais rápido que o anterior
...
;
ColorTbl
	byte $00 ,$0f ,$AE ,$1F      ; 00 = Regular Tanks #preto branco
       .byte $00 ,$0f ,$AE ,$1F      ; 01 = Tank Pong
       .byte $00 ,$0f ,$AE ,$1F      ; 10 = Jets
       .byte $00 ,$0f ,$AE ,$1F      ; 11 = Biplanes
